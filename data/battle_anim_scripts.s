...
Move_FIRE_FANG:
	...
	delay 6
	playsewithpan SE_M_FLAME_WHEEL2, SOUND_PAN_TARGET
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 2, 9, 0, RGB(28, 0, 0)
	waitforvisualfinish
	clearmonbg ANIM_TARGET
	blendoff
	delay 1
...
Move_THUNDER_FANG:
	...
	createsprite gSharpTeethSpriteTemplate, ANIM_ATTACKER, 2, 0, 32, 4, 0, -819, 10
	delay 10
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 2, 9, 0, RGB(31, 31, 22)
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, ANIM_TARGET, 2
	delay 1
	createsprite gLightningSpriteTemplate, ANIM_TARGET, 2, 0, -48
	delay 1
...
Move_SEED_BOMB:
	...
	loadspritegfx ANIM_TAG_EXPLOSION_6
	playsewithpan SE_M_SWAGGER, SOUND_PAN_ATTACKER
	createsprite gLeechSeedNoSproutsSpriteTemplate, ANIM_TARGET, 2, 15, 0, 0, 24, 35, -32
	delay 8
	playsewithpan SE_M_SWAGGER, SOUND_PAN_ATTACKER
	createsprite gLeechSeedNoSproutsSpriteTemplate, ANIM_TARGET, 2, 15, 0, -16, 24, 35, -40
	delay 8
	playsewithpan SE_M_SWAGGER, SOUND_PAN_ATTACKER
	createsprite gLeechSeedNoSproutsSpriteTemplate, ANIM_TARGET, 2, 15, 0, 16, 24, 35, -37
	delay 15
	playsewithpan SE_M_SELF_DESTRUCT, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMon2, 5, ANIM_TARGET, 5, 0, 28, 1
	createsprite gExplosionSpriteTemplate, ANIM_ATTACKER, 3, 0, 0, 1, 1
