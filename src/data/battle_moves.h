const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_FIRE_FANG] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_MAKES_CONTACT | FLAG_STRONG_JAW_AFFECTED,
        .category= MOVE_CATEGORY_PHYSICAL,
    },
    ...
    [MOVE_DRAIN_PUNCH] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_MAKES_CONTACT | FLAG_IRON_FIST_AFFECTED,
        .category= MOVE_CATEGORY_PHYSICAL,
    },
