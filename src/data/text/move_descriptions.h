...
static const u8 sDrainPunchDescription[] = _(
    "Punches the foe and steals\n"
    "half of the inflicted damage.");
...
static const u8 sHoneClawsDescription[] = _(
    "Sharpens claws to boost\n"
    "ATTACK and ACCURACY.");

static const u8 sBoulderPunchDescription[] = _(
...
static const u8 sHeatUpDescription[] = _(
